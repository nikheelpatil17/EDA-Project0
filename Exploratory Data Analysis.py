# This project focuses on conducting a thorough Exploratory Data Analysis (EDA) on Titanic Dataset.
# The primary objective is to gain a deep understanding of the dataset's characteristics, identify key trends, patterns, and relationships within the data, and uncover valuable insights that can inform further analysis or decision-making.
# Key Activities: Data Loading, Cleaning Data, Exploration & Visualization
